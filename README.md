...
4. Для каждого окружения создан отдельный баккет, где хранятся файлы состояний terraform. Сам файл, описывающий конфигурацию создания баккета находится непосредственно в папке terraform.
